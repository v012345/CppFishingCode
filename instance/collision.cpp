...
void collision::getPoint1Arr(Sprite** sp1, vector<utils::usePoint>& pointArr1) {
    ...
    utils::usePoint a4 = {-(*sp1)->getWidth() * (*sp1)->pivot.x, -(*sp1)->getHeight() * (*sp1)->pivot.y + (*sp1)->getHeight()};
...
bool collision::obbTest(Sprite** sp1, Sprite** sp2) {
    ...
    utils::usePoint xdSp1 = {this->getKeyMin(pointArr1, "x"), this->getKeyMax(pointArr1, "x")};
    utils::usePoint xdSp2 = {this->getKeyMin(pointArr2, "x"), this->getKeyMax(pointArr2, "x")};

    utils::usePoint ydSp1 = {this->getKeyMin(pointArr1, "y"), this->getKeyMax(pointArr1, "y")};
    utils::usePoint ydSp2 = {this->getKeyMin(pointArr2, "y"), this->getKeyMax(pointArr2, "y")};
